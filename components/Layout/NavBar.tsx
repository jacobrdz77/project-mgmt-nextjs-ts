...
const NavBar: React.FC = () => {
  return (
    <nav className="bg-primary sticky top-0 left-0 w-[208px] h-screen m-0 text-center text-white">
      {/* LOGO */}
      <div className="mt-4 mb-5 mx-auto text-[30px]">selfwork.</div>
      {/* Buttons */}
      <div className="mt-0 mb-auto w-full  text-[18px]">
        <div className="w-[164px] h-full flex flex-col mx-auto ">
          <a
            href="/tasks"
            className="w-full mx-auto mb-3 py-2.5 px-5 hover:bg-button rounded-[15px]"
          >
          ...
          >
            <div className="flex justify-center items-center w-full ">
              ...
              <div className="inline">Projects</div>
            </div>
          </a>
          <a
            href="/clients"
          ...
          >
            <div className="flex justify-center items-center w-full ">
              ...
              <div className="inline">Clients</div>
            </div>
          </a>
        </div>
      </div>
